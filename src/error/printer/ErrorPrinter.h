...
#include "ConstructorReturnWithValue.h"
...
private:
    ...
    std::wstring formattedErrorMessage(ErrorCode errorCode, const std::vector<ErrorMessageArgument> &args,
                                       unsigned int line = 0);
    ...
    void printConstructorReturnWithValue(const ConstructorReturnWithValue *error);
