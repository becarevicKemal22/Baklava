...
TEST_CASE("Executes basic increment statement", "[interpreter][controlFlow]") {
...
TEST_CASE("Executes basic decrement statement", "[interpreter][controlFlow]") {
...
TEST_CASE("Executes increment statement with 'za'", "[interpreter][controlFlow]") {
...
TEST_CASE("Executes decrement statement with 'za'", "[interpreter][controlFlow]") {
...
TEST_CASE("Executes increment statement with function call as 'za' value", "[interpreter][controlFlow]") {
...
TEST_CASE("Executes increment statement with array indexing", "[interpreter][controlFlow]") {
...
TEST_CASE("Executes increment statement with array indexing as increment amount", "[interpreter][controlFlow]") {
...
TEST_CASE("Throws indexing non-array error when incrementing non-array", "[interpreter][controlFlow]") {
...
TEST_CASE("Throws indexing out of bounds error when incrementing out of bounds", "[interpreter][controlFlow]") {
...
TEST_CASE("Throws non-integer index error when incrementing with non-integer index", "[interpreter][controlFlow]") {
...
TEST_CASE("Throws on non-number index value", "[interpreter][controlFlow]") {
...
TEST_CASE("Throws invalid lvalue error when incrementing with non-lvalue", "[interpreter][controlFlow]") {
...
TEST_CASE("Throws on non-number increment value", "[interpreter][controlFlow]") {
...
TEST_CASE("Throws on non-number variable to be incremented", "[interpreter][controlFlow]") {
